...
class verifiedScreen(QMainWindow):
    def __init__(self):
        ...
        self.tick_label.setGeometry(20, 60, 480, 800)

        pixmap = QPixmap('images/icons/verfiedIcon.png')
        scaled_pixmap = pixmap.scaled(450, 450, Qt.AspectRatioMode.KeepAspectRatio)
